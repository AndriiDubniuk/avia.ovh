...
export function BillingHome() {
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const response = await fetch(`${apiBaseUrl}/billing/checkouts`, {
        method: "POST",
        headers: {
        ...
        <header className="flex flex-col gap-4 border-b border-black/10 pb-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="display mt-3 text-4xl font-semibold sm:text-5xl">
              Окрема зона для річних підписок поруч із лендінгом.
            </h1>
          </div>
        ...
        <section className="grid flex-1 gap-8 py-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-black/10 bg-[#141414] p-7 text-white shadow-[0_28px_90px_-60px_rgba(0,0,0,0.65)]">
              ...
              <h2 className="display mt-4 text-4xl font-semibold">
                Один checkout зараз, кілька підписок далі.
              </h2>
              <p className="mt-4 max-w-xl text-base leading-7 text-white/70">
                Ця сторінка працює як окремий billing-контур під піддомен. Клієнт
                обирає план, переходить у checkout monobank, а після редиректу
                повертається на сторінку статусу й керування автоподовженням.
              </p>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <h2 className="display mt-2 text-3xl font-semibold">
                    Каталог уже готовий під розширення.
                  </h2>
                </div>
              </div>
          ...
          <div className="rounded-[2rem] border border-black/10 bg-[rgba(255,251,245,0.85)] p-6 shadow-[0_32px_90px_-60px_rgba(0,0,0,0.38)] sm:p-8">
            ...
            <h2 className="display mt-3 text-4xl font-semibold">
              Перший платіж активує підписку.
            </h2>
            ...
            <form className="mt-6 grid gap-4" onSubmit={onSubmit}>
              ...
              <div className="rounded-[1.5rem] border border-black/10 bg-black/[0.03] p-4 text-sm leading-6 text-black/68">
                Кнопка оплати веде в checkout monobank. На цій сторінці ми не
                показуємо логотипи платіжних систем окремо, щоб не розмазувати
                конверсію зайвим вибором.
              </div>
