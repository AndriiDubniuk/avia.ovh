...
type CockpitProps = {
  sky?: Sky;
  /** Підписи HUD для сторінок поза польотом. */
  scrollCue?: string;
...
export function Cockpit({
  ...
  return (
    <>
      ...
      {/* HUD із ALT … FT і THRUST % прибрано — це буквальні прилади літака.
          Метафора польоту лишається в графіці неба та шкалі прогресу. */}
