 ...
 * рядок показувався прямо на платіжному екрані. Показуємо повідомлення сервера
 * лише тоді, коли воно справді призначене людині.
 */

const TECHNICAL =
  /failed to fetch|networkerror|load failed|typeerror|referenceerror|syntaxerror|\[object |undefined|null|ECONNREFUSED|fetch failed|checkout status request failed/i;
